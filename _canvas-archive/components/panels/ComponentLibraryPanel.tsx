...
import type { TemplateCategory, ComponentTemplate } from '../../lib/components/componentLibrary';
...
const CATEGORY_ICONS: Record<TemplateCategory, () => React.JSX.Element> = {
  ui: BoxIcon,
  layout: LayoutIcon,
  form: FormIcon,
...
const CATEGORY_ICONS_LARGE: Record<TemplateCategory, () => React.JSX.Element> = {
  ui: BoxIconLarge,
...
export function ComponentLibraryPanel({
  ...
  const componentsByCategory = useMemo(() => getTemplatesByCategory(), []);
  ...
  const toggleCategory = (category: TemplateCategory): void => {
    ...
    <div style={styles.container}>
      ...
      <div style={styles.scrollContainer}>
        {filteredComponents ? (
          ...
          // Categories view
          (Object.keys(componentsByCategory) as TemplateCategory[]).map((category) => {
