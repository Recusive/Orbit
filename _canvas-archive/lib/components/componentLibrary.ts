...
// Note: Using TemplateCategory to avoid conflict with ComponentCategory from componentLibraryTypes
export type TemplateCategory = 'ui' | 'layout' | 'form' | 'data-display' | 'feedback';
 ...
 */
export function getTemplatesByCategory(): Record<TemplateCategory, ComponentTemplate[]> {
  const result: Record<TemplateCategory, ComponentTemplate[]> = {
    ui: [],
    layout: [],
    form: [],
    'data-display': [],
