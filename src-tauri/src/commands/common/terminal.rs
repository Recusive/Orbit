...
pub async fn terminal_create(
    ...
    perf_log!(PerfSource::Terminal, "terminal_create", {
...
pub async fn terminal_write(id: String, data: String) -> Result<()> {
    perf_log!(PerfSource::Terminal, "terminal_write", {
        let manager = get_terminal_manager();
...
pub async fn terminal_resize(id: String, cols: u16, rows: u16) -> Result<()> {
    perf_log!(PerfSource::Terminal, "terminal_resize", {
        let manager = get_terminal_manager();
...
pub async fn terminal_close(id: String) -> Result<()> {
    perf_log!(PerfSource::Terminal, "terminal_close", {
        let manager = get_terminal_manager();
        manager.close(&id)
    })
}
...
pub async fn terminal_list() -> Result<Vec<String>> {
    perf_log!(PerfSource::Terminal, "terminal_list", {
        let manager = get_terminal_manager();
        Ok(manager.list())
    })
}
...
pub async fn terminal_signal(id: String, signal: String) -> Result<()> {
    perf_log!(PerfSource::Terminal, "terminal_signal", {
...
pub async fn terminal_acknowledge(id: String, byte_count: u64) -> Result<()> {
    perf_log!(PerfSource::Terminal, "terminal_acknowledge", {
        let manager = get_terminal_manager();
...
pub async fn terminal_pending_bytes(id: String) -> Result<u64> {
    perf_log!(PerfSource::Terminal, "terminal_pending_bytes", {
        let manager = get_terminal_manager();
...
pub async fn terminal_foreground_process(id: String) -> Result<ForegroundProcess> {
    perf_log!(PerfSource::Terminal, "terminal_foreground_process", {
        let manager = get_terminal_manager();
...
pub async fn terminal_emit_prompt(
    ...
    perf_log!(PerfSource::Terminal, "terminal_emit_prompt", {
