...
macro_rules! trace_info {
    ($app:expr, $msg:expr) => {
        $crate::core::devmonitor::emit_trace($app, "info", module_path!(), $msg, None)
    };
    ($app:expr, $msg:expr, $fields:expr) => {
        $crate::core::devmonitor::emit_trace($app, "info", module_path!(), $msg, Some($fields))
    };
}
...
macro_rules! trace_warn {
    ($app:expr, $msg:expr) => {
        $crate::core::devmonitor::emit_trace($app, "warn", module_path!(), $msg, None)
    };
    ($app:expr, $msg:expr, $fields:expr) => {
        $crate::core::devmonitor::emit_trace($app, "warn", module_path!(), $msg, Some($fields))
    };
}
...
macro_rules! trace_error {
    ($app:expr, $msg:expr) => {
        $crate::core::devmonitor::emit_trace($app, "error", module_path!(), $msg, None)
    };
    ($app:expr, $msg:expr, $fields:expr) => {
        $crate::core::devmonitor::emit_trace($app, "error", module_path!(), $msg, Some($fields))
    };
}
...
macro_rules! trace_debug {
    ($app:expr, $msg:expr) => {
        $crate::core::devmonitor::emit_trace($app, "debug", module_path!(), $msg, None)
    };
    ($app:expr, $msg:expr, $fields:expr) => {
        $crate::core::devmonitor::emit_trace($app, "debug", module_path!(), $msg, Some($fields))
    };
}
...
macro_rules! span {
    ($app:expr, $name:expr) => {
        $crate::core::devmonitor::SpanGuard::new($app, $name, module_path!())
    };
    ($app:expr, $name:expr, $fields:expr) => {
        $crate::core::devmonitor::SpanGuard::with_fields($app, $name, module_path!(), $fields)
    };
}
