...
| `VIRTUOSO-SCROLLBAR-JITTER-COMPENSATION.md` | Three-tier scrollTop compensation for mid-list scrollbar jitter — MutationObserver + ResizeObserver + rAF fallback | 2026-04-02 |
