...
extension OrbitTerminal {
    ...
    /// because OrbitTerminal input triggers are a superset of what can be represented by a macOS
    ...
    /// handling for OrbitTerminal is handled at a lower level (usually). This function should generally only
    ...
    static func keyboardShortcut(for trigger: ghostty_input_trigger_s) -> KeyboardShortcut? {
        ...
        return KeyboardShortcut(
            key,
            modifiers: EventModifiers(nsFlags: OrbitTerminal.eventModifierFlags(mods: trigger.mods)))
    }
    ...
    /// A map from the OrbitTerminal key enum to the keyEquivalent string for shortcuts. Note that
...
// MARK: OrbitTerminal.Input.BindingFlags

extension OrbitTerminal.Input {
...
// MARK: OrbitTerminal.Input.KeyEvent
...
// MARK: OrbitTerminal.Input.Action
...
extension OrbitTerminal.Input.Action: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Key Action")

    static var caseDisplayRepresentations: [OrbitTerminal.Input.Action: DisplayRepresentation] = [
        .release: "Release",
        .press: "Press",
        .repeat: "Repeat"
    ]
...
// MARK: OrbitTerminal.Input.MouseEvent
...
// MARK: OrbitTerminal.Input.MouseState
...
extension OrbitTerminal.Input.MouseState: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Mouse State")

    static var caseDisplayRepresentations: [OrbitTerminal.Input.MouseState: DisplayRepresentation] = [
        .release: "Release",
        .press: "Press"
    ]
}

// MARK: OrbitTerminal.Input.MouseButton
...
extension OrbitTerminal.Input.MouseButton: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Mouse Button")

    static var caseDisplayRepresentations: [OrbitTerminal.Input.MouseButton: DisplayRepresentation] = [
        .unknown: "Unknown",
        .left: "Left",
        .right: "Right",
        .middle: "Middle"
    ...
    static var allCases: [OrbitTerminal.Input.MouseButton] = [
        .left,
        .right,
        .middle,
    ]
...
// MARK: OrbitTerminal.Input.ScrollMods
...
// MARK: OrbitTerminal.Input.Momentum
...
extension OrbitTerminal.Input.Momentum: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Scroll Momentum")

    static var caseDisplayRepresentations: [OrbitTerminal.Input.Momentum: DisplayRepresentation] = [
        .none: "None",
        .began: "Began",
...
extension OrbitTerminal.Input.Momentum {
...
extension OrbitTerminal.Input {
    ...
    struct Mods: OptionSet {
        ...
        init(nsFlags: NSEvent.ModifierFlags) {
            self.init(cMods: OrbitTerminal.ghosttyMods(nsFlags))
        }

        var nsFlags: NSEvent.ModifierFlags {
            OrbitTerminal.eventModifierFlags(mods: cMods)
        }
    }
}

// MARK: OrbitTerminal.Input.Key
...
extension OrbitTerminal.Input.Key: AppEnum {
    ...
    static var allCases: [OrbitTerminal.Input.Key] {
        return [
            // Letters (A-Z)
    ...
    static var caseDisplayRepresentations: [OrbitTerminal.Input.Key: DisplayRepresentation] = [
        // Letters (A-Z)
