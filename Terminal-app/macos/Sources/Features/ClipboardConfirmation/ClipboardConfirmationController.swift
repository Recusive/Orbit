...
class ClipboardConfirmationController: NSWindowController {
    ...
    init(surface: ghostty_surface_t, contents: String, request: OrbitTerminal.ClipboardRequest, state: UnsafeMutableRawPointer?, delegate: ClipboardConfirmationViewDelegate) {
