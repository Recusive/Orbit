...
class TerminalViewContainer: NSView {
    ...
    func orbitTerminalConfigDidChange(_ config: OrbitTerminal.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: OrbitTerminal.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
