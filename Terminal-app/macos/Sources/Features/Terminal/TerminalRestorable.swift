...
protocol TerminalRestorable: Codable {
    ...
    var baseConfig: OrbitTerminal.SurfaceConfiguration? { get }
}
...
extension TerminalRestorable {
    ...
    var baseConfig: OrbitTerminal.SurfaceConfiguration? { nil }
...
class TerminalWindowRestoration: NSObject, NSWindowRestoration {
    static func restoreWindow(
        ...
        if let focusedStr = state.focusedSurface {
            var foundView: OrbitTerminal.SurfaceView?
    ...
    private static func restoreFocus(to: OrbitTerminal.SurfaceView, inWindow: NSWindow, attempts: Int = 0) {
