...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: OrbitTerminal.SurfaceView.DerivedConfig?
    ...
    override func syncAppearance(_ surfaceConfig: OrbitTerminal.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: OrbitTerminal.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: OrbitTerminal.SurfaceView.DerivedConfig) {
