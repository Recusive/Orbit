...
struct ColorizedOrbitTerminalIcon {
    ...
    let frame: OrbitTerminal.MacOSIconFrame
...
extension ColorizedOrbitTerminalIcon: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        guard version == 0 || version == CodingKeys.currentVersion else {
            throw DecodingError.dataCorrupted(
                DecodingError.Context(
                    ...
                    debugDescription: "Unsupported ColorizedOrbitTerminalIcon version: \(version)"
                )
            )
        }
        ...
        let frame = try container.decode(OrbitTerminal.MacOSIconFrame.self, forKey: .frame)
...
extension ColorizedOrbitTerminalIcon: Equatable {
