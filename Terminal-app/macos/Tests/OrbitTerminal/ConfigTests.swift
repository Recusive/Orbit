...
@testable import OrbitTerminalKit
import SwiftUI
...
struct ConfigTests {
    ...
    @Test(arguments: [
        ("native", OrbitTerminal.Config.MacOSTitlebarStyle.native),
        ("transparent", OrbitTerminal.Config.MacOSTitlebarStyle.transparent),
        ("tabs", OrbitTerminal.Config.MacOSTitlebarStyle.tabs),
        ("hidden", OrbitTerminal.Config.MacOSTitlebarStyle.hidden),
    ])
    func macosTitlebarStyleValues(raw: String, expected: OrbitTerminal.Config.MacOSTitlebarStyle) throws {
    ...
    @Test(arguments: [
        ("always", OrbitTerminal.Config.ResizeOverlay.always),
        ("never", OrbitTerminal.Config.ResizeOverlay.never),
        ("after-first", OrbitTerminal.Config.ResizeOverlay.after_first),
    ])
    func resizeOverlayValues(raw: String, expected: OrbitTerminal.Config.ResizeOverlay) throws {
...
class TemporaryConfig: OrbitTerminal.Config {
    ...
    var optionalAutoUpdateChannel: OrbitTerminal.AutoUpdateChannel? {
        ...
        return OrbitTerminal.AutoUpdateChannel(rawValue: str)
    }
