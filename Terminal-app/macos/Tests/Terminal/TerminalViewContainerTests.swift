...
class MockConfig: OrbitTerminal.Config {
    internal init(backgroundBlur: OrbitTerminal.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: OrbitTerminal.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: OrbitTerminal.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.orbitTerminalConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.orbitTerminalConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.orbitTerminalConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless orbitTerminalConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.orbitTerminalConfigDidChange(config2, preferredBackgroundColor: .red)
