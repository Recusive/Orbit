...
final class OrbitTerminalThemeTests: OrbitTerminalCustomConfigCase {
    let windowTitle = "OrbitTerminalThemeTests"
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of OrbitTerminal are very slow and you may experience performance problems. Debug builds are only recommended during development."
