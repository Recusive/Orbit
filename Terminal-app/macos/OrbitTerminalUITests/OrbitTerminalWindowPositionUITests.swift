//
//  OrbitTerminalWindowPositionUITests.swift
...
final class OrbitTerminalWindowPositionUITests: OrbitTerminalCustomConfigCase {
    ...
    func testConfigOverridesCachedPositionAndSize() async throws {
        ...
        try updateConfig(
            """
            maximize = true
            title = "OrbitTerminalWindowPositionUITests"
            """
        )
