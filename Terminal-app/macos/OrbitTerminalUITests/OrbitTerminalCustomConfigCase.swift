//
//  OrbitTerminalCustomConfigCase.swift
//  OrbitTerminal
//
...
class OrbitTerminalCustomConfigCase: XCTestCase {
    ...
    func ghosttyApplication(defaultsSuite: String = OrbitTerminalCustomConfigCase.defaultsSuiteName) throws -> XCUIApplication {
