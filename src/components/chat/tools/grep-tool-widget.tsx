        ...
        <div className="flex items-center gap-2">
          ...
          {!isRunning && fileCount > 0 ? (
            <span className="text-xs text-muted-foreground">
              ({fileCount} {fileCount === 1 ? 'file' : 'files'}{isContentMode && matchCount !== fileCount ? `, ${String(matchCount)} matches` : ''})
            </span>
          ) : null}
          {isRunning ? (
                ...
                {isContentMode ? (
                  ...
                  Object.entries(groupedMatches).map(([filePath, fileMatches]) => (
                    <div key={filePath} className="mb-2">
                      ...
                      >
                        ...
                        <span className="text-muted-foreground truncate text-right flex-1" title={filePath}>
                          {filePath}
                        </span>
                      </button>
                  ...
                  matches.map((match, index) => (
                    ...
                    >
                      ...
                      <span className="text-muted-foreground truncate text-right flex-1" title={match.filePath}>
                        {match.filePath}
                      </span>
                    </button>
                  ))
