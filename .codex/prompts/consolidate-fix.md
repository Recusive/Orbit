...
argument-hint: CYCLE=<1-4>
---

# Consolidate and Fix

Two independent code reviews exist for cycle $CYCLE:

- `reviews/cycle-$CYCLE-claude.md`
- `reviews/cycle-$CYCLE-codex.md`
...
4. Log what you fixed to `reviews/cycle-$CYCLE-fixes.md`
...
Write to `reviews/cycle-$CYCLE-fixes.md`:
