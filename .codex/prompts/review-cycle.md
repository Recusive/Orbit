...
argument-hint: CYCLE=<1-4> MODEL=<codex|claude>
---
...
Save your complete review to: `reviews/cycle-$CYCLE-$MODEL.md`
...
- `git diff main --name-only` - list files changed
...
Write the following to `reviews/cycle-$CYCLE-$MODEL.md`:
