/**
 * Canvas UI Builder Entry Point
 *
 * Initializes Sentry error monitoring and renders the Canvas app
...
// ============================================
Sentry.init({
  ...getSentryConfig({ appTag: 'canvas', enableReplay: true }),
...
if (typeof __DEV__ !== 'undefined' && __DEV__) {
  Sentry.logger.info('Canvas app initialized', {
 ...
 * Component-level errors are handled by CanvasErrorBoundary.
 */
