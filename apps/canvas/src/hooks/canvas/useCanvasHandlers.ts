...
import {
  ...
  toFrameRelative,
  getAbsoluteBounds,
} from '../../lib/design/frameDetection';

import type { CanvasActions } from './useCanvasActions';
import type { IndexedComponent } from '../../lib/components/componentLibraryTypes';
import type { SandpackNodeData } from '../../sandpack/SandpackNode';
import type { UseDesignTreeReturn } from '../design/useDesignTree';
