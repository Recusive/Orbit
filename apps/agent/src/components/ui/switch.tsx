...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        'pointer-events-none relative z-10 block h-4 w-4 rounded-[5px] bg-white ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0',
