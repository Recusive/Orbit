    ...
    <div>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full rounded-lg border border-lg-separator p-4 hover:bg-lg-control-hover transition-[background-color] duration-150 text-left cursor-pointer"
        >
