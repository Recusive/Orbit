...
export const ChangeItem: React.FC<ChangeItemProps> = ({
  ...
  return (
    <div className="group flex items-center gap-2 px-3 h-7 hover:bg-accent transition-[background-color] duration-150">
      {/* Status indicator */}
      ...
      <div className="flex items-baseline gap-1.5 flex-1 min-w-0">
        {file.oldPath ? (
          <span className="truncate text-sm">
            <span className="text-gray-11">{oldFileName}</span>
        ...
        <span className="text-[10px] text-gray-11 truncate shrink-[2]">
      ...
      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-150">
        {onDiscard ? (
          <button
            ...
            disabled={isLoading}
            className="h-5 w-5 flex items-center justify-center rounded-md text-muted-foreground/50 hover:text-destructive hover:bg-accent active:scale-95 transition-[background-color,color,transform] duration-150"
            title="Discard"
          >
            <X className="h-3 w-3" />
          </button>
        ...
        <button
          ...
          disabled={isLoading}
          className="h-5 w-5 flex items-center justify-center rounded-md text-muted-foreground/50 hover:text-foreground hover:bg-accent active:scale-95 transition-[background-color,color,transform] duration-150"
