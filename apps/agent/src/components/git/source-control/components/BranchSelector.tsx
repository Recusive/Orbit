  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="flex items-center gap-1.5 text-sm min-w-0 hover:bg-accent rounded-md px-2 py-1 -ml-2 active:scale-[0.98] transition-[background-color,transform] duration-150 disabled:opacity-40"
      >
        {isCheckingOut ? (
