...
export const ConversationItem: FC<ConversationItemProps> = ({
  ...
  const itemContent = (
    ...
    >
      <button
        className={cn(
          'flex items-center h-7 w-full rounded-lg pl-[7px] overflow-hidden hover:bg-gray-2 dark:hover:bg-gray-4 transition-[background-color,padding] duration-100',
          isHovered ? 'pr-7' : 'pr-9',
          active ? 'bg-gray-2 dark:bg-gray-4 text-foreground' : 'text-gray-11 hover:text-gray-12'
        )}
