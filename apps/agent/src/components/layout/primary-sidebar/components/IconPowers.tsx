/**
 * IconPowers - Custom SVG icon for the Powers sidebar item
 * Four connected circles representing modular capabilities
 */
import type { FC } from 'react';

interface IconPowersProps {
  readonly className?: string;
}

export const IconPowers: FC<IconPowersProps> = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
