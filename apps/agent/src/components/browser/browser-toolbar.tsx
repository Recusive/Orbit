    ...
    <div className="flex items-center gap-1 px-2 bg-chat-area shrink-0" style={{ height: 35 }}>
      ...
      <div className="flex-1 mx-2">
        <input
          ...
          className="w-full h-7 px-3 rounded-[9px] bg-lg-control dark:bg-background border-2 border-transparent text-sm outline-none placeholder:text-lg-text-secondary focus:border-foreground/30 transition-colors duration-200"
        />
      </div>
