...
export async function handleSubagentsList(
  ...
  try {
    ...
    logger.error('List subagents error', { error: errorMessage });
    window.postMessage(
      {
...
export async function handleSubagentsCreate(
  ...
  try {
    ...
    logger.error('Create subagent error', { error: errorMessage });
    window.postMessage(
      {
        type: 'subagents:error',
        uuid: crypto.randomUUID(),
...
export async function handleSubagentsUpdate(
  ...
  try {
    ...
    logger.error('Update subagent error', { error: errorMessage });
    window.postMessage(
      {
        type: 'subagents:error',
        uuid: crypto.randomUUID(),
...
export async function handleSubagentsDelete(
  ...
  try {
    ...
    logger.error('Delete subagent error', { error: errorMessage });
    window.postMessage(
      {
        type: 'subagents:error',
        uuid: crypto.randomUUID(),
...
export async function handleSubagentsGenerate(
  ...
  try {
    ...
    logger.error('Generate subagent error', { error: errorMessage });
    window.postMessage(
      {
        type: 'subagents:error',
        uuid: crypto.randomUUID(),
