...
import type { TerminalInstanceManager } from '@/services/terminal/terminal-instance-manager';
import type { ShellType } from '@/types/protocol';

import { useTauri } from '@/hooks/agent/use-tauri';
import { getTerminalInstanceManager } from '@/services/terminal/terminal-instance-manager';
