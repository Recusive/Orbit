...
describe("ConfigMarkdown: frontmatter parsing", () => {
  let parsed: Awaited<ReturnType<typeof ConfigMarkdown.parse>>

  beforeAll(async () => {
    parsed = await ConfigMarkdown.parse(import.meta.dir + "/fixtures/frontmatter.md")
  })
...
describe("ConfigMarkdown: frontmatter parsing w/ empty frontmatter", () => {
  let result: Awaited<ReturnType<typeof ConfigMarkdown.parse>>

  beforeAll(async () => {
    result = await ConfigMarkdown.parse(import.meta.dir + "/fixtures/empty-frontmatter.md")
  })
...
describe("ConfigMarkdown: frontmatter parsing w/ no frontmatter", () => {
  let result: Awaited<ReturnType<typeof ConfigMarkdown.parse>>

  beforeAll(async () => {
    result = await ConfigMarkdown.parse(import.meta.dir + "/fixtures/no-frontmatter.md")
  })
...
describe("ConfigMarkdown: frontmatter parsing w/ Markdown header", () => {
  let result: Awaited<ReturnType<typeof ConfigMarkdown.parse>>

  beforeAll(async () => {
    result = await ConfigMarkdown.parse(import.meta.dir + "/fixtures/markdown-header.md")
  })
...
describe("ConfigMarkdown: frontmatter has weird model id", () => {
  let result: Awaited<ReturnType<typeof ConfigMarkdown.parse>>

  beforeAll(async () => {
    result = await ConfigMarkdown.parse(import.meta.dir + "/fixtures/weird-model-id.md")
  })
