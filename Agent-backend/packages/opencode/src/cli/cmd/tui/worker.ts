...
const startEventStream = (input: { directory: string; workspaceID?: string }): void => {
...
export const rpc = {
  ...
  async checkUpgrade(input: { directory: string }): Promise<void> {
  ...
  setWorkspace(input: { workspaceID?: string }): void {
