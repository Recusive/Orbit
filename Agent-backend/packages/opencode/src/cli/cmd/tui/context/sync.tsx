      ...
      switch (event.type) {
        ...
        case "permission.replied": {
          ...
          setStore(
            ...
            produce((draft) => {
              if (draft) draft.splice(match.index, 1)
            }),
          )
          break
        }
        ...
        case "permission.asked": {
          ...
          setStore(
            ...
            request.sessionID,
            produce((draft) => {
              if (draft) draft.splice(match.index, 0, request)
            }),
          )
          break
        }
        ...
        case "session.deleted": {
          ...
          if (result.found) {
            setStore(
              "session",
              produce((draft: typeof store.session) => {
        ...
        case "message.updated": {
          ...
          setStore(
            ...
            produce((draft) => {
              if (draft) draft.splice(result.index, 0, event.properties.info)
            }),
          )
          const updated = store.message[event.properties.info.sessionID]
          if (updated !== undefined && updated.length > 100) {
            ...
            batch(() => {
              setStore(
                ...
                event.properties.info.sessionID,
                produce((draft) => {
                  if (draft) draft.shift()
                }),
              )
              setStore(
                "part",
                produce((draft) => {
                  // eslint-disable-next-line @typescript-eslint/no-dynamic-delete -- SolidJS store produce requires dynamic delete for record cleanup
        ...
        case "message.removed": {
          ...
          if (result.found) {
            setStore(
              ...
              event.properties.sessionID,
              produce((draft) => {
                if (draft) draft.splice(result.index, 1)
              }),
            )
          }
          break
        ...
        case "message.part.updated": {
          ...
          setStore(
            ...
            produce((draft) => {
              if (draft) draft.splice(result.index, 0, event.properties.part)
            }),
          )
          break
        }
    ...
    const result = {
      ...
      session: {
        ...
        status(sessionID: string) {
          ...
          if (session.time.compacting !== undefined) return "compacting"
