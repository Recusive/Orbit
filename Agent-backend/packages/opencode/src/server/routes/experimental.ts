...
export const ExperimentalRoutes = lazy(() =>
  new Hono()
      ...
      async (c) => {
        ...
        return c.json(
          tools.map((t) => ({
            ...
            parameters: "_def" in t.parameters ? zodToJsonSchema(t.parameters) : t.parameters,
          })),
        )
      },
    )
    ...
    .get(
      ...
      (c) => {
        const sandboxes = Project.sandboxes(Instance.project.id)
    ...
    .get(
      ...
      describeRoute({
        ...
        description:
          "Get a list of all Orbit sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
