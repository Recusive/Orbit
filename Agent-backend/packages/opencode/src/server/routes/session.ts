  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Orbit sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Orbit session.",
        tags: ["Session"],
    ...
    .get(
      ...
      (c) => {
        const sessionID = SessionID.make(c.req.valid("param").sessionID)
        const session = Session.children(sessionID)
        return c.json(session)
      },
    )
    .get(
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Orbit session for interacting with AI assistants and managing conversations.",
    ...
    .patch(
      ...
      (c) => {
        ...
        if (updates.title !== undefined) {
          session = Session.setTitle({ sessionID, title: updates.title })
        }
        if (updates.time?.archived !== undefined) {
          session = Session.setArchived({ sessionID, time: updates.time.archived })
        }
    ...
    .post(
      ...
      (c) => {
        SessionPrompt.cancel(SessionID.make(c.req.valid("param").sessionID))
        return c.json(true)
      },
    )
    .post(
    ...
    .post(
      ...
      async (c) => {
        ...
        const msgs = Session.messages({ sessionID })
    ...
    .get(
      ...
      validator(
        ...
        z
          ...
          .refine((value) => value.before === undefined || value.limit !== undefined, {
    ...
    .delete(
      ...
      (c) => {
        const params = c.req.valid("param")
        SessionPrompt.assertNotBusy(SessionID.make(params.sessionID))
    ...
    .delete(
      ...
      (c) => {
        ...
        Session.removePart({
          sessionID: SessionID.make(params.sessionID),
          messageID: MessageID.make(params.messageID),
          partID: PartID.make(params.partID),
        })
        return c.json(true)
      },
    )
    .patch(
      ...
      (c) => {
        ...
        const part = Session.updatePart(body)
        return c.json(part)
      },
    )
    .post(
    ...
    .post(
      ...
      (c) => {
        ...
        PermissionNext.reply({
          requestID: PermissionID.make(params.permissionID),
