...
export namespace ConfigMarkdown {
  ...
  export function files(template: string): RegExpExecArray[] {
    return Array.from(template.matchAll(FILE_REGEX))
  }

  export function shell(template: string): RegExpExecArray[] {
  ...
  export async function parse(filePath: string): Promise<matter.GrayMatterFile<string>> {
