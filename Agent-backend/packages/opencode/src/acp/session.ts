...
export class ACPSessionManager {
  ...
  setModel(sessionId: string, model: ACPSessionState["model"]): ACPSessionState {
    const session = this.get(sessionId)
    session.model = model
  ...
  setVariant(sessionId: string, variant?: string): ACPSessionState {
    const session = this.get(sessionId)
  ...
  setMode(sessionId: string, modeId: string): ACPSessionState {
    const session = this.get(sessionId)
