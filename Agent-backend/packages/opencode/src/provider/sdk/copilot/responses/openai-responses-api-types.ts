...
export type OpenAIResponsesIncludeOptions = OpenAIResponsesIncludeValue[] | undefined | null
...
export interface OpenAIResponsesComputerCall {
  type: "computer_call"
  id: string
  status?: string
}

export interface OpenAIResponsesLocalShellCall {
...
export interface OpenAIResponsesLocalShellCallOutput {
 ...
 */
export interface OpenAIResponsesFileSearchToolComparisonFilter {
  /**
 ...
 */
export interface OpenAIResponsesFileSearchToolCompoundFilter {
  /**
