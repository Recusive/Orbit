...
import type { LanguageModelV2CallWarning, LanguageModelV2Prompt, LanguageModelV2ToolCallPart } from "@ai-sdk/provider"
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    detail: (part.providerOptions as Record<string, Record<string, unknown> | undefined> | undefined)
                      ?.openai?.imageDetail,
                  }
                  ...
                  return {
                    ...
                    ...(typeof part.data === "string" && isFileId(part.data, fileIdPrefixes)
                      ? { file_id: part.data }
                      : {
                          filename: part.filename ?? `part-${String(index)}.pdf`,
          ...
          switch (part.type) {
            case "text": {
              input.push({
                ...
                id:
                  ((part.providerOptions as Record<string, Record<string, unknown> | undefined> | undefined)?.openai
                    ?.itemId as string | undefined) ?? undefined,
              })
              break
            }
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                ...
                const itemId =
                  ((part.providerOptions as Record<string, Record<string, unknown> | undefined> | undefined)?.openai
                    ?.itemId as string | undefined) ?? part.toolCallId
                input.push({
            ...
            case "file": {
              // File content is not expected in assistant messages for Responses API
              break
            }
            ...
            case "reasoning": {
              ...
              if (reasoningId !== undefined && reasoningId !== null) {
                const reasoningMessage: OpenAIResponsesReasoning | undefined =
                  reasoningId in reasoningMessages ? reasoningMessages[reasoningId] : undefined
