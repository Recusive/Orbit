...
export function createOpenaiCompatible(options: OpenaiCompatibleProviderSettings = {}): OpenaiCompatibleProvider {
  ...
  const createChatModel = (modelId: OpenaiCompatibleModelId): LanguageModelV2 => {
  ...
  const createResponsesModel = (modelId: OpenaiCompatibleModelId): LanguageModelV2 => {
  ...
  const createLanguageModel = (modelId: OpenaiCompatibleModelId): LanguageModelV2 => createChatModel(modelId)

  const provider = function (modelId: OpenaiCompatibleModelId): LanguageModelV2 {
