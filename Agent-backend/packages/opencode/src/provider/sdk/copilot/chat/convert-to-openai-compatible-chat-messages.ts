...
function getOpenAIMetadata(message: { providerOptions?: SharedV2ProviderMetadata }): Record<string, unknown> {
      ...
      case "assistant": {
        ...
        for (const part of content) {
          ...
          switch (part.type) {
            ...
            case "file":
            case "tool-result": {
              // These content types are not expected in assistant messages for OpenAI-compatible APIs
              break
            }
          }
        }
