...
beforeAll(async () => {
  ...
  mock.module("@orbit.build/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@orbit.build/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@orbit.build/ui/icon", () => ({ Icon: () => null }))
  mock.module("@orbit.build/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
